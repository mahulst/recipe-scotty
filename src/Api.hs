...
getDefaultConnectionString Development =
  "host=localhost port=5432 user=postgres dbname=recipe_development"
getDefaultConnectionString Production =
  "host=localhost port=5432 user=postgres dbname=recipe_production"
getDefaultConnectionString Test =
  "host=localhost port=5432 user=postgres dbname=recipe_test"
